!function(e, t) {
    ...
    return function(e) {
        ...
        var n = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
            ...
            function e(t) {
                var i = this;
                if (r(this, e), this.config = e.mergeSettings(t), this.selector = "string" == typeof this.config.selector ? document.querySelector(this.config.selector) : this.config.selector, 
                ...
                this.transformProperty = e.webkitOrNot(), [ "resizeHandler", "touchstartHandler", "touchendHandler", "touchmoveHandler", "mousedownHandler", "mouseupHandler", "mouseleaveHandler", "mousemoveHandler", "clickHandler" ].forEach(function(e) {
                    i[e] = i[e].bind(i);
                }), this.init();
            }
            return s(e, [ {
                ...
                value: function(e, t, i) {
                    ...
                    this.currentSlide = r ? this.currentSlide + 1 : this.currentSlide, this.innerElements.splice(t, 0, e), 
